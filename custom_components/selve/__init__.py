...
class SelveGateway(object):
    ...
    async def async_setup(self):
        ...
        # Gateway
        hass.services.async_register(DOMAIN, 'ping_gateway', self.ping_gateway, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'gateway_state', self.gateway_state, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'get_gateway_firmware_version', self.get_gateway_firmware_version, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'get_gateway_serial', self.get_gateway_serial, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'get_gateway_spec', self.get_gateway_spec, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'reset', self.reset, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'factory_reset_gateway', self.factory_reset_gateway, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'set_led', self.set_led, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'get_led', self.get_led, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'update_all_devices', self.update_all_devices)
        hass.services.async_register(DOMAIN, 'set_forward', self.set_forward, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'get_forward', self.get_forward, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'set_events', self.set_events, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'get_events', self.get_events, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'get_duty', self.get_duty, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'get_rf', self.get_rf, supports_response=SupportsResponse.ONLY)

        #Devices
        hass.services.async_register(DOMAIN, 'device_scan_start', self.device_scan_start, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_scan_stop', self.device_scan_stop, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_scan_result', self.device_scan_result, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_save', self.device_save, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_get_ids', self.device_get_ids, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_get_info', self.device_get_info, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_get_values', self.device_get_values, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_set_function', self.device_set_function, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_set_label', self.device_set_label, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_set_type', self.device_set_type, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_delete', self.device_delete, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_write_manual', self.device_write_manual, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_update_values', self.device_update_values, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_set_value', self.device_set_value, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_set_target_value', self.device_set_target_value, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_set_state', self.device_set_state, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_move_up', self.device_move_up, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_move_down', self.device_move_down, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_move_pos1', self.device_move_pos1, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_move_pos2', self.device_move_pos2, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_move_pos', self.device_move_pos, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_move_stop', self.device_move_stop, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_move_step_up', self.device_move_step_up, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'device_move_step_down', self.device_move_step_down, supports_response=SupportsResponse.ONLY)

        #Group
        hass.services.async_register(DOMAIN, 'group_read', self.group_read, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'group_write', self.group_write, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'group_get_ids', self.group_get_ids, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'group_delete', self.group_delete, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'group_move_up', self.group_move_up, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'group_move_down', self.group_move_down, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'group_stop', self.group_stop, supports_response=SupportsResponse.ONLY)

        #Iveo
        hass.services.async_register(DOMAIN, 'iveo_set_repeater', self.iveo_set_repeater, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_get_repeater', self.iveo_get_repeater, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_set_label', self.iveo_set_label, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_set_type', self.iveo_set_type, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_get_type', self.iveo_get_type, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_get_ids', self.iveo_get_ids, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_factory_reset', self.iveo_factory_reset, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_teach', self.iveo_teach, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_learn', self.iveo_learn, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_command_manual', self.iveo_command_manual, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'iveo_command_automatic', self.iveo_command_automatic, supports_response=SupportsResponse.ONLY)

        #Sensor
        hass.services.async_register(DOMAIN, 'sensor_teach_start', self.sensor_teach_start, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sensor_teach_stop', self.sensor_teach_stop, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sensor_teach_result', self.sensor_teach_result, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sensor_get_ids', self.sensor_get_ids, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sensor_get_info', self.sensor_get_info, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sensor_get_values', self.sensor_get_values, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sensor_set_label', self.sensor_set_label, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sensor_delete', self.sensor_delete, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sensor_write_manual', self.sensor_write_manual, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sensor_update_values', self.sensor_update_values, supports_response=SupportsResponse.ONLY)
        
        #Sender
        hass.services.async_register(DOMAIN, 'sender_teach_start', self.sender_teach_start, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sender_teach_stop', self.sender_teach_stop, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sender_teach_result', self.sender_teach_result, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sender_get_ids', self.sender_get_ids, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sender_get_info', self.sender_get_info, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sender_get_values', self.sender_get_values, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sender_set_label', self.sender_set_label, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sender_delete', self.sender_delete, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sender_write_manual', self.sender_write_manual, supports_response=SupportsResponse.ONLY)
        hass.services.async_register(DOMAIN, 'sender_update_values', self.sender_update_values, supports_response=SupportsResponse.ONLY)
